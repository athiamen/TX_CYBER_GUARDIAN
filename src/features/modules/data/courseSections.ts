...
const COURSE_SECTION_TEMPLATES = [
  {
    ...
    development: [
      ...
      'Le but de cette introduction est de montrer que le risque apparaît souvent dans des situations ordinaires. Plus le contexte semble banal, plus il est facile d agir trop vite. C est justement pour cela que ce cours insiste sur les bons réflexes avant l action.',
